...
SECRET_KEY = 'django-insecure-k1^bhoyq@&17abu)!g#uw-51=-_uzddn72!pm+sbb(=$s!_1!3'
...
DATABASES = {
   'default': {
        ...
        'NAME': 'students',          # Replace with your database name
        'USER': 'root',          # Replace with your database user
        'PASSWORD': 'root',  # Replace with your database password
        'HOST': '127.0.0.1',                   # Set to 'localhost' or your MySQL server IP
